...
const files=['README.md','AGENTS.md',...['ARCHITECTURE','CONFIGURATION','EMAIL','OPERATIONS','REPOSITORY_SELECTION','IMPLEMENTATION_PLAN','SECURITY','EXAMPLE_CODEX_HANDOFF','JEV_EVALUATION'].map(n=>`docs/${n}.md`)];
